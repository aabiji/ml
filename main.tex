...
A forward pass is done to compute and cache values of hidden units in each layer, which will be used to compute gradients. Note that hidden units are not conserved across epochs and batche.
\begin{align*}
