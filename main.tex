...
(2) To rotate by 180 degrees, F is flipped vertically then horizontally. The gradient dilated by the current layer's stride and zero-padded by the current layer's kernel size minus one.
